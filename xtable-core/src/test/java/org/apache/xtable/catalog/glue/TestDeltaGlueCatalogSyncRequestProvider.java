...
public class TestDeltaGlueCatalogSyncRequestProvider extends GlueCatalogSyncTestBase {

  private DeltaGlueCatalogSyncRequestProvider deltaGlueCatalogSyncRequestProvider;

  private DeltaGlueCatalogSyncRequestProvider createDeltaGlueCatalogSyncHelper() {
    return new DeltaGlueCatalogSyncRequestProvider(testConfiguration, mockGlueSchemaExtractor);
  }

  void setupCommonMocks() {
    deltaGlueCatalogSyncRequestProvider = createDeltaGlueCatalogSyncHelper();
  }
  ...
  void testGetCreateTableInput() {
    ...
    TableInput expected =
        TableInput.builder()
            ...
            .parameters(deltaGlueCatalogSyncRequestProvider.getTableParameters())
            .storageDescriptor(
                StorageDescriptor.builder()
                    ...
                    .serdeInfo(
                        SerDeInfo.builder()
                            .parameters(
                                deltaGlueCatalogSyncRequestProvider.getSerDeParameters(
    ...
    TableInput output =
        deltaGlueCatalogSyncRequestProvider.getCreateTableInput(
  ...
  void testGetUpdateTableInput() {
    ...
    TableInput output =
        deltaGlueCatalogSyncRequestProvider.getUpdateTableInput(
